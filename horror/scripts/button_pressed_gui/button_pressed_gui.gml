/// @description button_pressed(x, y, sprite_index)
/// @param x
/// @param  y
/// @param  sprite_index
function button_pressed(argument0, argument1, argument2) {
	...
	var spriteleft = xx - (spritewidth);
	var spriteright = xx + (spritewidth);
	var spritetop = yy - (spriteheight);
	var spritebottom = yy + (spriteheight);
	result = false;

	if device_mouse_x(0) > spriteleft and device_mouse_x(0) < spriteright and device_mouse_y(0) > spritetop and device_mouse_y(0) < spritebottom
	    {
